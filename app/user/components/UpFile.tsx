...
const UpFile = ({ roomId, currentUserId }: UpFileProps) => {
  ...
  return (
    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 10, marginLeft: 10 }}>
      {loading && <ActivityIndicator size="large" color="#0000ff" style={{ marginRight: 10 }} />}
      
      <TouchableOpacity style={[styles.uploadButton, { marginLeft: 0 }]} onPress={pickFile}>
        <Text style={styles.uploadButtonText}>📎</Text>
      </TouchableOpacity>

      <TouchableOpacity style={[styles.uploadButton, { marginLeft: 10 }]} onPress={pickImage}>
        <Text style={styles.uploadButtonText}>🖼</Text>
      </TouchableOpacity>
    </View>
